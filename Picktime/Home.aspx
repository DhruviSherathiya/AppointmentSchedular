...
<body>
    ...
    <form id="formDisplay" runat="server">
        <div>
            <asp:GridView ID="GridViewSchedule" runat="server" DataKeyNames="ID" CellPadding="4" CssClass="inner" ForeColor="#333333" GridLines="None" OnSelectedIndexChanged="GridViewSchedule_SelectedIndexChanged" AutoGenerateDeleteButton="True" DataSourceID="SqlDataSource1">
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:userConnection %>" 
